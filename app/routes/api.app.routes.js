...
module.exports = app => {
    ...
    // router.get('/api/postThreadImageAccount', post_thread_controller.postThreadImageAccount);

    //auth
    // router.post('/api/login-openid', auth.loginByOpenId);

    //api lấy danh mục
    // router.get('/api/listPortfolios', check.authenticated, portfolios_controller.getAllPortfoliosByUser);
    app.use('/', router);
};

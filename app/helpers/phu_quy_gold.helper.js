...
const DEFAULT_TABLE     = "log_crawl_phu_quy";
const COMPANY_PHU_QUY   = 6;
exports.insertLogsPhuQuy = async function (datas) {
    try {
        ...
        console.log("EX insertLogsPhuQuy", e);
        return false;
    }
};
...
exports.getLastUpdateTime = async () => {
    try {
        const result = await sequelize.query(
            "SELECT last_update FROM `log_crawl_phu_quy` order by id DESC limit 1", {
        ...
        console.log("Ex getLastUpdateTimePhuQuy",e);

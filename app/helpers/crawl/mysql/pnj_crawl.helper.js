...
const pnj_gold_helper = require("./pnj_gold.helper"); // sửa path cho đúng
...
exports.fetchGiavangOrgPNJ = async function fetchGiavangOrgPNJ() {
    ...
    rows.each((index, row) => {
        ...
        if (cells.length >= 4) {
            ...
            currentArea = area; // lưu lại để dùng cho dòng 3 cột tiếp theo (SJC, v.v.)
        ...
        // ======= ÁP DỤNG CÁC QUY TẮC BẠN YÊU CẦU =======
        ...
        items.push({
            name,                                   // PNJ / SJC / Vàng 750 (18K) / ...
            area,                                   // TPHCM / Hà Nội / Miền Tây / Toàn quốc / ...
            buy_raw,
            sell_raw,
            buy,
            sell,

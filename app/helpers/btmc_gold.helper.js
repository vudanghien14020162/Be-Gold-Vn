...
const DEFAULT_TABLE     = "log_crawl_btmc";
const COMPANY_BTMC      = 4;
exports.insertLogsBTMC = async function (datas) {
    try {
        ...
        console.log("EX insertLogsBTMC", e);
        return false;
    }
};
...
exports.getLastUpdateTime = async () => {
    try {
        const result = await sequelize.query(
            "SELECT last_update FROM `log_crawl_btmc` order by id DESC limit 1", {
        ...
        console.log("Ex getLastUpdateTimeBTMC",e);

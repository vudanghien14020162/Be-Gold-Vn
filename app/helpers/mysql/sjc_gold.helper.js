...
const DEFAULT_TABLE     = "log_crawl_sjc";
const COMPANY_SJC       = 1;
exports.insertLogsSJC = async function (datas) {
    try {
        ...
        console.log("EX insertLogsSJC", e);
        return false;
    }
};
...
exports.getLastUpdateTime = async () => {
    try {
        const result = await sequelize.query(
            "SELECT last_update FROM `log_crawl_sjc` order by id DESC limit 1", {
        ...
        console.log("Ex getLastUpdateTimeSJC",e);

...
const DEFAULT_TABLE     = "log_crawl_btmh";
const COMPANY_BTMH      = 5;
exports.insertLogsBTMH = async function (datas) {
    try {
        ...
        console.log("EX insertLogsBTMH", e);
        return false;
    }
};
...
exports.getLastUpdateTime = async () => {
    try {
        const result = await sequelize.query(
            "SELECT last_update FROM `log_crawl_btmh` order by id DESC limit 1", {
        ...
        console.log("Ex getLastUpdateTimeBTMH",e);

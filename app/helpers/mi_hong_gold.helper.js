...
const DEFAULT_TABLE     = "log_crawl_mi_hong";
const COMPANY_MI_HONG   = 7;

exports.insertLogsMiHong = async function (datas) {
    try {
        ...
        console.log("EX insertLogsMiHong", e);
        return false;
    }
};
...
exports.getLastUpdateTime = async () => {
    try {
        const result = await sequelize.query(
            "SELECT last_update FROM `log_crawl_mi_hong` order by id DESC limit 1", {
        ...
        console.log("Ex getLastUpdateTimeMiHong",e);
